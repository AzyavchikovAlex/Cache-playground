...
template<typename K>
class LIRS2Policy : public KeyReplacementPolicy<K> {
 private:
 ...
 public:
  explicit LIRS2Policy(size_t size) :
  ...
  void Resize(size_t new_size) override {
    assert(new_size == max_lir_keys_count_ + max_hir_keys_count_);
  }
};
